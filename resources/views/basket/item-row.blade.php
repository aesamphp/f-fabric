<div class="row single-row">
    <div class="col-xs-0 col-sm-1 js-container-magnific">
        <a href="{{ asset($item->design->getWatermarkImagePath()) }}">
            <div class="body-col image" style="background-image: url('{{ asset(asset($item->design->getThumbnailImagePath())) }}');">
            </div>
        </a>													
    </div>
    <div class="col-xs-11">
                ...
                <div class="body-col first">
                    <div class="col-xs-12">
                        <div class="body-col-textarea">
                            ...
                            <a href="{{ route('view.basket.design', ['id' => $item->design_id, 'basketId' => $item->id]) }}" class="body-col__link body-col__link--edit">Edit this design</a>
                            @endif
                            <div class="js-container-magnific mobile-only-image">
                                <a href="{{ asset($item->design->getWatermarkImagePath()) }}">
                                    <div class="mobile-only-image__img" style="background-image: url('{{ asset($item->design->getThumbnailImagePath()) }}');"></div>
                                </a>
