<div class="row single-row">
    <div class="col-xs-0 col-sm-1 js-container-magnific">
        <a href="{{ asset(getColourAtlasImagePath()) }}">
            <div class="body-col image" style="background-image: url('{{ asset(getColourAtlasImagePath()) }}');">
            </div>
        </a>            												
    </div>
    <div class="col-xs-11">
                    ...
                    <div class="col-xs-12">
                        <div class="body-col-textarea">
                            ...
                            <div class="js-container-magnific mobile-only-image">
                                <a href="{{ asset(getColourAtlasImagePath()) }}">
                                    <div class="mobile-only-image__img" style="background-image: url('{{ asset(getColourAtlasImagePath()) }}');"></div>
                                </a>
