<div class="row single-row">
    <div class="col-xs-0 col-sm-1 js-container-magnific">
        <a href="{{ asset($item->design_images->watermarkImagePath) }}">
            <div class="body-col image" style="background-image: url('{{ asset($item->design_images->thumbnailImagePath) }}');">
            </div>
        </a>            												
    </div>
    <div class="col-xs-11">
                ...
                <div class="body-col first">
                    <div class="col-xs-12">
                        <div class="body-col-textarea">
                            <p class="body-col-textarea__item">{{ $item->design_images->fileOriginalName }} (Your Design)</p>
                            ...
                            <a href="{{ route('view.basket.manipulate', ['id' => $item->id]) }}" class="body-col__link body-col__link--edit">Edit this design</a>
                            <div class="js-container-magnific mobile-only-image">
                                <a href="{{ asset($item->design_images->watermarkImagePath) }}">
                                    <div class="mobile-only-image__img" style="background-image: url('{{ asset($item->design_images->thumbnailImagePath) }}');"></div>
                                </a>
