...
class DiscountCodeGroups extends AppModel
{
	 ...
	 * @var string
	 */
	protected $table = 'discount_code_groups';
	 ...
	 * @var array
	 */
	protected $fillable = ['prefix', 'use_limit_id', 'use_limit', 'date_limit_id', 'from_date', 'to_date', 'value_type_id', 'value', 'min_value', 'quantity', 'used'];
	...
	{
		return [
			'prefix' => 'required|max:255|unique:discount_codes,code,' . $this->id,
