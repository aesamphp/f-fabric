@section('page_title', 'Shipping Package Types')
...
<main class="sticky-footer">
    <div class="container">
        <div class="row">
            ...
            <div class="col s12">
                <div class="row">
                    <a class="btn teal waves-effect waves-light right" href="{{ route('admin::new.shipping.package.type') }}">Add New</a>
                </div>
            </div>
            ...
            <table class="responsive-table data-table">
                ...
                <tbody>
                    @include('admin::setting.shipping.package-type-row')
                </tbody>
            </table>
            @else
