@section('page_title', 'Shipping Zones')
...
<main class="sticky-footer">
    <div class="container">
        <div class="row">
            ...
            <div class="col s12">
                <div class="row">
                    <a class="btn teal waves-effect waves-light right" href="{{ route('admin::new.shipping.zone') }}">Add New</a>
                </div>
            </div>
            @if (count($zones) > 0)
            <table class="responsive-table data-table">
                ...
                <tbody>
                    @include('admin::setting.shipping.shipping-zone-row')
                </tbody>
            </table>
            @else
