...
<main class="sticky-footer">
    <div class="container">
        <div class="row">
            ...
            <div class="col s12">
                <div class="row">
                    <a class="btn teal waves-effect waves-light right" href="{{ route('admin::new.faq') }}">Add New</a>
                    <a class="btn teal waves-effect waves-light right btn-push-left" href="{{ route('admin::view.faq.categories') }}">View Categories</a>
                </div>
            </div>
            @if (count($faqs) > 0)
