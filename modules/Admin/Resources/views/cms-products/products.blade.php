@section('page_title', 'CMS Products')
...
<main class="sticky-footer">
    <div class="container">
        <div class="row">
            ...
            <div class="col s12">
                <div class="row">
                    <a class="btn teal waves-effect waves-light right" href="{{ route('admin::new.cms.product') }}">Add New</a>
                </div>
            </div>
            @if (count($products) > 0)
            <table class="responsive-table data-table">
                ...
                <tbody>
                    @include('admin::cms-products.product-row')
                </tbody>
            </table>
            @else
