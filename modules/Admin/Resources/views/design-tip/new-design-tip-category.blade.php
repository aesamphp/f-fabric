@section('page_title', 'New Design Tip Category')
            ...
            <form class="col s12" method="POST" action="{{ Request::url() }}">
                ...
                <div class="row">
                    ...
                    <div class="input-field col s12">
                        ...
                        <a class="btn grey lighten-1 waves-effect waves-light right btn-push-left" href="{{ route('admin::view.design.tip.categories') }}">Cancel</a>
                    </div>
                </div>
            </form>
