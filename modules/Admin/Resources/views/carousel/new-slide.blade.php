        ...
        <div class="row">
            ...
            <form class="col s12" method="POST" action="{{ Request::url() }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="input-field col s12">
                        <textarea id="content" name="content" class="materialize-textarea height-10">{{ old('content') }}</textarea>
                    ...
                    <div class="input-field col s12 m6">
                        <input id="sort" type="text" name="sort" class="validate" value="{{ old('sort') }}" />
