@section('page_title', 'Product Material Quantity')
            ...
            <form class="col s12" method="POST" action="{{ Request::url() }}">
                ...
                <div class="row">
                    <div class="input-field col s12 m6">
                        <select id="product_quantity_id" name="product_quantity_id" class="material-select auto-select" data-value="{{ $productMaterialQuantity->product_quantity_id }}">
                    ...
                    <div class="input-field col s12 m6">
                        <input id="price" type="text" name="price" class="validate" value="{{ $productMaterialQuantity->price }}" />
