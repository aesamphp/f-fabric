@section('page_title', 'Weekly Contests')
...
<main class="sticky-footer">
    <div class="container">
        <div class="row">
            ...
            <div class="col s12">
                <div class="row">
                    <a class="btn teal waves-effect waves-light right" href="{{ route('admin::new.weekly.contest') }}">Add New</a>
                </div>
            </div>
            @if (count($weeklyContests) > 0)
            <table class="responsive-table data-table">
                ...
                <tbody>
                    @include('admin::weekly-contest.weekly-contest-row')
                </tbody>
            </table>
            @else
