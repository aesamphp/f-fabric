@section('page_title', $materialGroup->title)
    ...
    <main class="sticky-footer">
        <div class="container">
            <div class="row top-row">
                ...
                <div class="col s12">
                    <div class="row">
                        <a class="btn delete-btn waves-effect waves-light right" href="{{ route('admin::delete.material-group', ['id' => $materialGroup->id]) }}">Delete</a>
                    </div>
                </div>
                ...
                <form class="col s12" method="POST" action="{{ Request::url() }}">
                    ...
                    <div class="row">
                        <div class="input-field col s12 m6">
                            <input id="title" type="text" name="title" class="validate" value="{{ $materialGroup->title }}"/>
                            ...
                            <tbody>
                                @foreach ($materials as $material)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-delete" type="submit" title="Delete" data-action="{{ route('admin::delete.material-group.material', ['id' => $materialGroup->id, 'material_id' => $material->id]) }}">
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            ...
                            <a class="btn grey lighten-1 waves-effect waves-light right btn-push-left" href="{{ route('admin::view.material-groups') }}">Cancel</a>
                        </div>
                    </div>
                </form>
